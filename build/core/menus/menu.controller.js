...
var MenuCtrl = /** @class */ (function () {
    ...
    MenuCtrl.getInstance = function () {
        if (!MenuCtrl.instance)
            MenuCtrl.instance = new MenuCtrl();
        return MenuCtrl.instance;
    };
    MenuCtrl.prototype.getAll = function (req, res) {
    ...
    MenuCtrl.prototype.get = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var menu;
            return __generator(this, function (_a) {
                try {
    ...
    MenuCtrl.prototype.add = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var menu, newMenu, io, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    MenuCtrl.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var menu, io, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    MenuCtrl.prototype.delete = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var io, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, menu_model_1.default.findByIdAndDelete(req.params.id)];
                    case 1:
                        _a.sent();
                        io = req.app.get('io');
...
exports.default = MenuCtrl.getInstance();
