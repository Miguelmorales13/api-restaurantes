...
var image_controller_1 = __importDefault(require("./image/image.controller"));
...
var Routes = /** @class */ (function () {
    ...
    Routes.prototype.images = function () {
        this.router.get('/images/', image_controller_1.default.getAll);
        this.router.get('/images/:id', image_controller_1.default.get);
        this.router.post('/images/', image_controller_1.default.add);
        this.router.put('/images/:id', auth_middleware_1.default.auth, image_controller_1.default.update);
        this.router.delete('/images/:id', auth_middleware_1.default.auth, image_controller_1.default.delete);
    };
    ...
    Routes.prototype.menus = function () {
        this.router.get('/menus/', menu_controller_1.default.getAll);
        this.router.get('/menus/:id', menu_controller_1.default.get);
